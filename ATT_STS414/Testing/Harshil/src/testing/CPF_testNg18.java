...
public class CPF_testNg18 {
	...
	public void f() {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Delete Project')]")).click();
		driver.findElement(By.xpath("//input[@id='delProj']")).sendKeys("3");
		// body/section[1]/div[1]/form[1]/input[2]
